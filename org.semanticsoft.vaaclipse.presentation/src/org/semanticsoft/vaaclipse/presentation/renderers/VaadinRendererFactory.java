...
public class VaadinRendererFactory extends GenericRendererFactory
{
	...
	public GenericRenderer getRenderer(MUIElement uiElement)
	{
		...
		else if (uiElement instanceof MPerspectiveStack)
		{
			...
			{
				perspectiveStackRenderer = ContextInjectionFactory.make(PerspectiveStackRenderer.class, context);
			}
		...
		else if (uiElement instanceof MPerspective)
		{
			...
			{
				perspectiveRenderer = ContextInjectionFactory.make(PerspectiveRenderer.class, context);
			}
		...
		else if (uiElement instanceof MPlaceholder)
		{
			...
			{
				placeholderRenderer = ContextInjectionFactory.make(PlaceholderRenderer.class, context);
			}
			return placeholderRenderer;
		}
		else if (uiElement instanceof MArea) //must be before MPartSashContainer becouse more special type
		{
			if (areaRenderer == null)
			{
				areaRenderer = ContextInjectionFactory.make(AreaRenderer.class, context);
			}
			return areaRenderer;
		}
