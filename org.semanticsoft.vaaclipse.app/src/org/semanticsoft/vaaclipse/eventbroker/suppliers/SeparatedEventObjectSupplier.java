...
public class SeparatedEventObjectSupplier extends EventObjectSupplier {
	@Inject
	@Optional
	...
	// This is a temporary code to ensure that bundle containing
		...
		protected String getTopic(IObjectDescriptor descriptor) {
			...
			System.err.println("IT IS : "+applicationInstanceId);
			return applicationInstanceId+"/"+qualifier.value();
		}
