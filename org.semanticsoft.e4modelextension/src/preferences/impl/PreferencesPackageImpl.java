...
import e4modelextension.impl.E4modelextensionPackageImpl;
...
import preferences.BooleanFieldEditor;
import preferences.BooleanFieldStyle;
import preferences.ComboFieldEditor;
import preferences.DirectoryFieldEditor;
import preferences.Entry;
import preferences.FieldEditor;
import preferences.FileFieldEditor;
import preferences.IntegerFieldEditor;
import preferences.ListEditor;
import preferences.ListFieldEditor;
import preferences.PreferencesCategory;
import preferences.PreferencesFactory;
import preferences.PreferencesPackage;
import preferences.PreferencesPage;
import preferences.RadioGroupFieldEditor;
import preferences.ScaleFieldEditor;
import preferences.StringFieldEditor;
...
public class PreferencesPackageImpl extends EPackageImpl implements PreferencesPackage {
	 ...
	 * @see preferences.PreferencesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static PreferencesPackage init() {
		...
		E4modelextensionPackageImpl theE4modelextensionPackage = (E4modelextensionPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(E4modelextensionPackage.eNS_URI) instanceof E4modelextensionPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(E4modelextensionPackage.eNS_URI) : E4modelextensionPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getPreferencesCategory_ChildCategories(), this.getPreferencesCategory(), null, "childCategories", null, 0, -1, PreferencesCategory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPreferencesCategory_ParentCategory(), this.getPreferencesCategory(), null, "parentCategory", null, 0, 1, PreferencesCategory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
